...
/****** Object:  Table [RP].[TBL_ForecastParameters_RF]    Script Date: 1/31/2020 5:10:17 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [RP].TBL_ForecastParameters_RF(
	[PK_ID_ForecastParameter_RF] [int] IDENTITY(1,1) NOT NULL,
	[FK_ID_forecastIteration] [int] NULL,
	[tempoTimbri_SVMforecastParameter] [datetime2](7) NULL,
